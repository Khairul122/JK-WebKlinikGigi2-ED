...
$query = "INSERT INTO rekam_medis (pasien_id, dokter_id, ruang_id, keluhan, diagnosa, tanggal, pembayaran, created_at, created_by) 
          VALUES ('$pasien_id', '$dokter_id', '$ruang_id', '$keluhan', '$diagnosa', '$tanggal', '$pembayaran', '$created_at', '$created_by')";
